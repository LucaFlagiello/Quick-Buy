...
export default function FeaturesArea() {
  ...
  return (
    <section className="w-max-[1000px] mt-[3.5rem] mb-[4rem]">
      <div className="flex justify-center gap-x-6">
        <div className={`flex justify-center gap-x-[1rem] border-${theme} w-[20rem] py-[1.1rem] border-solid border-[1px] rounded-[4px]`}>
        ...
        <div className={`flex justify-center items-center gap-x-[1rem] border-${theme} text-[18px] w-[20rem] py-[1.1rem] border-solid border-[1px] rounded-[4px]`}>
        ...
        <div className={`flex justify-center gap-x-[1rem] border-${theme} text-[18px] w-[20rem] py-[1.1rem] border-solid border-[1px] rounded-[4px]`}>
