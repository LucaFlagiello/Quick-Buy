...
const Nav = () => {
  ...
  return (
    <nav className="bg-primary-color box-border max-w-full h-[65px] flex justify-center gap-x-[4.8rem] items-center">
      <div onMouseEnter={() => setShowCategories(true)} className="bg-secondary-color relative flex items-center gap-x-2 h-10 px-10 py-6 rounded-[5px] cursor-pointer">
        <FontAwesomeIcon icon={faBars} className='text-white' />
        <h3 className='text-white font-Poppins font-medium text-md'>All categories</h3>
        <ul  onMouseLeave={() => setShowCategories(false)} className={showCategories ? 'visible  transition ease duration-[.2s] absolute w-full text-gray-800 text-[15px] font-Poppins bottom-0 left-0 top-14 shadow-lg h-fit' :  'invisible hidden'}>
      ...
      <div className='flex h-[44px] font-Poppins'>
        <div className='bg-white relative cursor-pointer pr-0 flex  items-center  rounded-l-md justify-between min-w-[110px] text-[14px] px-5 z-10' onClick={() => changeCategories()}>
          ...
          <ul className={searchCategory ? 'opacity-1 visible absolute top-[46px] left-0 rounded-[4px] text-[13px] bg-white w-full shadow-md duration-[.2s] ease transition-drop-in transform-[50%] scale-[1] translate-y-[0]' : 'absolute w-full left-0 invisible transform-[50% 0] scale-[0.75] translate-y-[-21px] ease-out'}>
      ...
      <div className='flex gap-x-5'>
        ...
        <div className='flex-col relative cursor-pointer' onMouseEnter={() => setIsMouseOnAccount(true)} onMouseLeave={() => setIsMouseOnAccount(false)}>
          ...
          <div className={isMouseOnAccount ? 'absolute opacity-1 transition duration-[.3s] easy  shadow-md left-[-170px] px-4 pt-6' : ' translate-y-[10px] shadow-md left-[-170px] px-4 pt-6 absolute transition-drop-in duration-[.4s]  pointer-events-none opacity-0'}>
            ...
            <div className='flex gap-x-3 justify-between mt-4'>
              <button className='bg-primary-color font-Roboto font-medium text-[14px] text-white px-[26px] py-[4px] rounded-[4px] hover:bg-white hover:text-primary-color border-primary-color border-[1px] transition duration-[.5s] ease'>JOIN</button>
              <button className='font-Roboto font-medium text-[14px] border-primary-color border-[1px] rounded-[4px] px-[16px] text-primary-color hover:bg-primary-color hover:text-white transition duration-[.5s] ease'>SIGN IN</button>
            </div>
            <ul className='font-Poppins text-light-black grid gap-y-[10px] my-4'>
              <li className='flex items-center gap-x-2 hover:text-primary-color cursor-pointer transition duration-[.3s] ease'>
