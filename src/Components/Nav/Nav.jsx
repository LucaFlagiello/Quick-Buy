...
const Nav = () => {
  ...
  return (
    <nav className="static bg-primary-color box-border max-w-full h-[65px] flex justify-center gap-x-[4.8rem] items-center">
      <div className="bg-secondary-color relative flex items-center gap-x-2 h-10 px-10 py-6 rounded-[5px] cursor-pointer">
        ...
        <ul className='visible  transition ease duration-[.2s] absolute w-full text-gray-800 text-[15px] font-Poppins bottom-0 left-0 top-14 shadow-lg h-fit py-[rem] z-10'>
